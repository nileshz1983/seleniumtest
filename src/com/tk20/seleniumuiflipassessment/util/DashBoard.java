...
content.add(DataProvider.progressBar);
 ...
 //Added By Ameet on Feb 13,2017
 toggleButton = new JToggleButton("Collapse");
 toggleButton.setBounds(540,5,50,15);
 ...
 /**
	...
	* 
	* This method kills the entire execution
	*/	
 DataProvider.shut.setBackground(Color.RED);
 DataProvider.shut.setBounds(70, 273,80, 20);
 
     frame.add( DataProvider.shut);
     DataProvider.shut.addActionListener(this);
     DataProvider.shut.addActionListener(new ActionListener(){
   ...
   //Added By Ameet 
     DataProvider.pause.setBackground(Color.ORANGE);
     DataProvider.resume.setBackground(Color.green);
     DataProvider.pause.setBounds(190,273, 80, 20);
     DataProvider.resume.setBounds(310,273, 80, 20);
     frame.add(DataProvider.pause);
     frame.add(DataProvider.resume);
     DataProvider.testlink.setBounds(430, 273,100, 20);
     DataProvider.testlink.setBackground(Color.PINK);
         frame.add(DataProvider.testlink);
         DataProvider.testlink.addActionListener(this);
         DataProvider.testlink.addActionListener(new ActionListener(){
     	    public void actionPerformed(ActionEvent e) {
 		    	...
 		    	try{
 		    	report.generateHTMLReport(t,"Build");
 		    	Thread.sleep(1000);
       ...
       //Added By Ameet 
         ...
         DataProvider.p.setBorder(border);
        // DataProvider.p.setBorder(BorderFactory.createTitledBorder("Control panel"));
 
         //DataProvider.p.setBorder(BorderFactory.createLineBorder(Color.black));

         DataProvider.p.setBounds(20, 255, 550, 50);
frame.add(DataProvider.p);
...
//code to start and stop timer for all suites
 ...
 public void collapseExpandFrame(ActionEvent ev)
 {
	 if(toggleButton.isSelected())
	 {
		 ...
		 toggleButton.setBounds(540,5,50,15);
		 fail_count.setBounds(30, 5, 190, 20); 
		 fail_count_value.setBounds(240, 5, 100, 20);
		 button.setBounds(250, 5, 100, 20);
		 total_loc.setBounds(30, 23, 200, 20);
		 total_loc_value.setBounds(240, 23, 400, 20);
		 
		 suite_count.setVisible(false);
		 suite_count_value.setVisible(false);
		 module_name.setVisible(false);
	 ...
	 else
	 {
		 ...
		 total_loc.setBounds(30, 180, 200, 20);
		 total_loc_value.setBounds(240, 180, 400, 20);
		 suite_count.setVisible(true);
		 suite_count_value.setVisible(true);
...
/*Modified By Ameet on Feb 13,2007
 * for Displaying Iterations on the Dashboard
 */

public  void setTestCaseName(String tcName,int iter,int lines)
{ 
	
	 if(lines>2)
	 {
		 displayTestCase_value.setForeground(Color.BLUE);
	 displayTestCase_value.setText(": "+tcName+" [Iteration "+iter+"]" );
	 
	 }
	 else
	 {
		 displayTestCase_value.setForeground(Color.DARK_GRAY);
