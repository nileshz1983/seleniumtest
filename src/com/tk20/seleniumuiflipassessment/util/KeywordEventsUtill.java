...
public class KeywordEventsUtill {
	...
	Long delayTime5 = Long.parseLong(CONFIG.getProperty("pauseDelay5"));
	Long delayTime2 = Long.parseLong(CONFIG.getProperty("pauseDelay2"));
	Long delayTime3 = Long.parseLong(CONFIG.getProperty("pauseDelay3"));
	static Long jQueryLoadTime=Long.parseLong(CONFIG.getProperty("jQueryLoadTime"));
	static Long jsciptLoadTime=Long.parseLong(CONFIG.getProperty("jsciptLoadTime"));
	...
	String expectedAlert= CONFIG.getProperty("unsaved_work_alert");
	 ...
	 * 
	 * Nilesh- 20 Sept 2016. Modified method to handle Incosistent Alert.
	 * 
	 * @param object
	 * @param data
	 * @return
 ...
 */
	...
	public String moveToFrameByXpath(String object, String data) {
		...
		try {
			//waitForPageLoad(driver);
			//System.out.println("inside moveToFrameByXpath ---");
			WebElement iframe =driver.findElement(By.xpath(OR.getProperty(object))); //wait.until(explicitWaitForElement(By.xpath(OR.getProperty(object))));
	 ...
	 * NIlesh- 20 Sept 2016 -MOdified method to handle UnhandledAlertException
	 * @param object
	 * @param data
	 * @return
	 * @throws InterruptedException 
	...
	public String verifyTextinInput(String object, String data) {
		...
		try {
			...
			WebElement ele =wait.until(explicitWaitForElement((By.xpath(OR.getProperty(object)))));//driver.findElement(By.xpath(OR.getProperty(object))); //
	...
	public String clickRadio(String object, String data) {
		...
		WebElement ele=null;
		try {
			//System.out.println("inside clickRadio ");
			//waitForPageLoad(driver);
    ...
    //Modified By Karan Sood on 25th March 2016
    // modified While Loop Code
	// xpath eg = //div[not(@style='display: none;')]/a[contains(@class,'icon-close-circle pull-right')]
	...
	public String pause(String object, String data) {
		...
		return Constants.KEYWORD_PASS+ " - " + delayTime5/1000 +" Second Delay";
	}
	
	
	/**
	 * Added By Karan Sood on 9th Sept 2016
	 * Delay execution time by 2 seconds.
	 * 
	 * @param object - No Object Needed
	 * @param data - No Data Needed
	 * @return
	 */
	public String pause2(String object, String data) {
		try {
		...
		return Constants.KEYWORD_PASS+ " - " + delayTime2/1000 +" Second Delay";
	}
	
	
	/**
	 * Added By Karan Sood on 9th Sept 2016
	 * Delay execution time by 3 second.
	 * 
	 * @param object - No Object Needed
	 * @param data - No Data Needed
	 * @return
	 */
	public String pause3(String object, String data) {
		try {
			logger.debug("Delay execution by 3 sec");
			Thread.sleep(delayTime3);
		} catch (Exception e) {

			return Constants.KEYWORD_FAIL + "Unable to pause" + e.getMessage();
		}
		return Constants.KEYWORD_PASS+ " - " + delayTime3/1000 +" Second Delay";
	}
	...
	*/
...

	{
		try {
			...
			ApplicationSpecificKeywordEventsUtil obj1=new ApplicationSpecificKeywordEventsUtil();
			obj1.clickElementIfPresent(src,data);		
...

	{
		try {
			...
			String src = obj[0].trim();
			ApplicationSpecificKeywordEventsUtil obj1=new ApplicationSpecificKeywordEventsUtil();
			String click=obj1.clickElementIfPresent(src,data);
			Thread.sleep(Integer.parseInt(CONFIG.getProperty("pausefckeditor")));
			WebElement trg = wait.until(explicitWaitForElement((By.xpath(OR.getProperty(obj[1])))));
			if(trg.isDisplayed())
			{
			logger.debug("enter the message in FCKeditor");
			WebElement ele = wait.until(explicitWaitForElement((By.xpath(OR.getProperty(obj[1])))));
			...
			{
				return Constants.KEYWORD_FAIL+ " --  Could not clicked";
			}
		}
	 ...
	 * Nilesh- 20 Sept 2016. MOdified method to handle Incosistent Alert.
	 * */
	public String isWebElementPresent(final String object, String data) throws InterruptedException {
		logger.debug("Entered into isWebElementPresent()");
		try {
			
			waitForPageLoad(driver);
			
			int element = explictWaitForElementSize(object);//driver.findElements(By.xpath(OR.getProperty(object))).size();//
			//isInConsistentAlert(object,data);
			if (element == 0) {
				logger.debug("webElement not present.." + element);
				return Constants.KEYWORD_FAIL + " -- No webElement present";
			} else
				//isInvalidAlert(object,data);
...
//		} 
   ...
   //  edited by Surender on 01 April, 2015, Added code to check ATTRIBUTE_VALUE
     ...
     *         
     * Modified By Surender on 15th Jan 2016
     * Used partialLinkText for clicking on next pagination link.         
     */
    public String elementIsPresentWithPagination(String object, String data) {
        ...
        try {
            ...
            while (true) {
                ...
                List<WebElement> next_Link_List = driver.findElements(By.partialLinkText(OR.getProperty("next_link")));
    ...
    /**
     * 15/09/2016 Added By Nilesh 
     * This method is used to make the driver to wait for javascripts and jquery load  
     * */
